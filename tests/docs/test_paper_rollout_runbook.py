...
def test_paper_rollout_runbook_documents_health_history_closeout_checklist() -> None:
    ...
    required_phrases = [
        ...
        "paper_strategy_tuning_evidence_chain_paper-20260624_<timestamp>.json",
        "strategy_capture_source: latest_existing_capture",
        ...
        "paper_catalyst_postmortem_paper-20260624_<timestamp>.json",
        ...
        "--catalyst-postmortem",
        "hold signoff pending another paper-only catalyst sample",
