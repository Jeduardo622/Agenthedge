...
def test_paper_rollout_runbook_documents_health_history_closeout_checklist() -> None:
    ...
    required_phrases = [
        ...
        "stability_blocker: insufficient_session_count",
        "sessions_shortfall",
        ...
        "fewer than the required closed paper sessions",
        ...
        "paper_stability_evidence_chain_paper-20260624_<timestamp>.json",
        "record-decision",
        ...
        "paper_strategy_tuning_gate_decision_<timestamp>.json",
        "PAPER_STRATEGY_TUNING_GATE_HOLD",
        "catalyst quality, consensus misses, and data-gap blockers",
        "threshold_evaluations",
        "--min-catalyst-hit-rate",
        "--data-gap-review",
        "review_entry_issue_count",
        "poetry run python -m cli.paper_strategy_data_gap_review",
        "paper_strategy_data_gap_review_<timestamp>.json",
        "PAPER_STRATEGY_DATA_GAP_REVIEW_NEEDS_EVIDENCE",
        "missing fundamentals, sentiment, and catalyst research inputs",
        "poetry run python -m cli.paper_strategy_data_gap_evidence",
        "paper_strategy_data_gap_evidence_<symbol>_<reason>_<timestamp>.json",
        "PAPER_STRATEGY_DATA_GAP_EVIDENCE_READY",
        "--acceptance-reason",
        "--review-entry-json",
        "PAPER_STRATEGY_DATA_GAP_REVIEW_PARTIAL",
        "partial_data_gap_review",
        "unmatched_review_entry",
        "review_entry_issues",
        "paper_only: True",
